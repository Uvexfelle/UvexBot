...
export const getTitreId = (live) => {
    try {
        ...
        const target = getIdFromText(categorieTwitch, 'force_no_fallback');
        const gId = target?.game_id || target?.uid;
        ...
        console.error(`[ça pue du cul...] getTitreId n'as pas pu trouver d'uid :`, err);
        return null;
    }
};
